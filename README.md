...
The app leverages sentence-level NLP embeddings to capture user intent and match it against a custom Spotify track dataset with pre-computed playlist vibe vectors.
...
- Stack: React, FastAPI, Docker, SentenceTransformers, Spotify Web API
...
- Embedding Model: SentenceTransformer (MiniLM) embeddings of user input vs averaged playlist titles
...
- Spotify OAuth integration planned (future enhancement)
